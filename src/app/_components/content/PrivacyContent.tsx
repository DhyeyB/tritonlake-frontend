...
const PrivacyContent: React.FC<ButtonStateHandlerProps> = ({ setIsButtonEnabled }) => {
    ...
    return (
        <div className="modal-body pt-0 pb-15 px-5 px-xl-20">
            ...
            <div id="policy-container" className="bg-secondary py-10 px-5" style={{ height: "300px", overflowY: "scroll" }}>
                <ol>
                    <li>
                        <h2>Introduction</h2>
                        <p>
                            Welcome to TritonLake. These Privacy policies govern your use of our website, products, and services (&quot;Services&quot;). By accessing or using our Services, you agree
